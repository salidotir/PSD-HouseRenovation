...
client.subscribe('electrician-quotation-recieved', async function ({ task, taskService }) {
  ...
  // const address = task.variables.get('address');
  var list_electrician = task.variables.get('list_plumber');

  restclient.get('http://localhost:8080/electrician-quotation-recieved/', function (data, response) {
