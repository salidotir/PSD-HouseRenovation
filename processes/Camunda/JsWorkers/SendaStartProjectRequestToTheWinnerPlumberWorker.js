...
client.subscribe('winner-plumber-start-project', async function ({ task, taskService }) {
  // Put your business logic here

 

  restclient.get('http://localhost:8080/winner-plumber-start-project/', function (data, response) {
